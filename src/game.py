...
class Game:
    def __init__(self, players: int = 4, max_turns: int = 100) -> None:
        ...
        self.chance_cards = Cards(
            [
                ...
                Card(
                    ...
                    lambda p: _advance_to(p, spaces.ST_CHARLES_PLACE),
                ),
                Card(
                ...
                Card("Bank pays you dividend of $50", lambda p: _payout(p, 50)),
                Card("Get Out of Jail Free", _receive_get_out_of_jail_free),
                Card("Go Back 3 Spaces", self._go_back_three_spaces),
                Card(
        ...
        self.community_cards = Cards(
            [
                ...
                Card("You inherit $100", lambda p: _payout(p, 100)),
            ]
        )
    ...
    def _go_back_three_spaces(self, p: Player):
        p.space = (p.space - 3) % len(self.board)
